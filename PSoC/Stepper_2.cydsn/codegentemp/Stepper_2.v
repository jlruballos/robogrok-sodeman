// ======================================================================
// Stepper_2.v generated from TopDesign.cysch
// 06/27/2021 at 13:25
...
module top ;
	...
	cy_clock_v1_0
		#(.id("12904a96-3d71-4922-9b93-f82c786643b3"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("63fadc14-bf51-4873-b745-8cf9154bcf70"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("57d67066-ba66-4a52-b57d-0070fac1e89c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("60b0aa28-0b20-44c0-9080-566b333d6303"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    assign Net_377 = Net_381 & Net_382;


    assign Net_378 = ~(Net_381 | Net_382);


    assign Net_387 = ~Net_381;


    assign Net_379 = Net_387 & Net_382;


    assign Net_380 = Net_381 & Net_390;


    assign Net_390 = ~Net_382;
